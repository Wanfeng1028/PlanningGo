import pathlib
p = pathlib.Path(r'E:\code\javascript\project\PlanningGo\src\server\routes\agentChat.ts')
c = p.read_text(encoding='utf-8')
old_import = 'import { handleAgentMessage } from "../modules/agent/chatRouter.js";'
new_import = 'import { handleAgentMessage } from "../modules/agent/chatRouter.js";\nimport { runAgentChatStream } from "../modules/agent/agentRuntime.js";\nimport { env } from "../config/env.js";'
old_block = '''        let agentResponse: AgentResponse;
        try {
...
new_block = '''        function hasAnyLlmKey(): boolean {
          return Boolean(
            env.OPENAI_API_KEY ||
            env.QWEN_API_KEY ||
...
c2 = c.replace(old_import, new_import).replace(old_block, new_block)
p.write_text(c2, encoding='utf-8')
print('UPDATED_AGENT_CHAT')
