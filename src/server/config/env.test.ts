...
const baseProdEnv = {
  ...
  OPEN_MAP_TILE_URL: "https://tiles.example.com/{z}/{x}/{y}.png",
  OPEN_MAP_NOMINATIM_URL: "https://nominatim.example.com",
  OPEN_MAP_OVERPASS_URL: "https://overpass.example.com/api/interpreter",
  OPEN_MAP_ROUTE_URL: "https://osrm.example.com",
  OPEN_MAP_TIMEOUT_MS: 5000,
  OPEN_MAP_PUBLIC_DEMO_OK: false,
