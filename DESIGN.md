...
最终站点只保留六个主导航入口，内部用子视图、步骤、Tab、弹窗、Drawer、Bottom Sheet 承载 43/28/100 中的所有页面主题。

| 最终导航 | 页面/子视图 | 来自 43 页 | 来自 28 页 | 来自最终 100 页 | 实现形态 |
|---|---|---|---|---|---|
| 首页 | 官网首页 / 价值叙事 / 问题定义 / Demo 故事 / 能力总览 / 流程地图 / 已登录演示入口 | 001 官网首页、042 营销长页 | 044 官网首页、062 营销长页 | 001-007 | 首页长页 sections |
| 功能 | 功能入口 / 先试试 / 一句话输入 / 需求对话 / 约束收集 | 011、012、013 | 048、049 | 008-010、014-018 | `/features` 子流程 |
| 功能 | 定位授权 / 定位中 / 起点确认 / POI 半径 / 地图交通读取 | 018、025、027 | 052、063、065 | 011-013、019、023、035-037 | 授权弹窗 + 地图子视图 |
| 功能 | 预解析三方案 / Agent 工作台 / 工具调用栈 / 风险复核 | 014、015、016、017 | 045、050、051、053 | 020-034 | 卡片流 + 对比视图 |
| 功能 | 餐厅详情 / 预约表单 / 排队状态 / 菜单建议 / 亲子友好检查 | 018、025、026 | 052、063、064 | 038-042 | 页面子视图 + 表单弹窗 |
| 功能 | 电影锁座 / 活动票务 / 鲜花蛋糕配送 | 026 | 064 | 043-046 | 可选加购 Drawer / Sheet |
| 功能 | 授权总览 / 细粒度授权 / 支付交接 / 日历通知授权 | 019、026 | 064 | 047-052 | Modal；移动端 Bottom Sheet |
| 功能 | 执行队列 / 预约中 / 锁座中 / 配送中 / 完成 / 失败兜底 | 020、027 | 065、070 | 053-059、073-074 | 执行状态页面 + Toast |
| 功能 | 分享给家人/朋友 / 多人投票 / 反馈修改 / 协作后改版 / 最终行程 | 021、022、039、040 | 054、057 | 060-066 | 协作页面 + 投票弹窗 |
| 功能 | What-if 晚出发 / 下雨 / 预算 / 交通延误 / 天气重规划 | 027、034、035 | 065 | 067-072 | 模拟器子视图 |
| 功能 | 行程评分 / 记忆沉淀 / 历史洞察 | 023、024 | 055 | 075-077 | 完成页 + 记忆卡片 |
| 场景案例 | 家庭西湖下午 / 朋友展览 Citywalk / 情侣减脂晚餐 / 雨天室内兜底 / 亲子低负担 / 晚出发压缩 / 答辩故事板 | 034、035、042 | 061、062 | 078-084 | 案例页 sections |
| 设计亮点 | 设计系统 / 颜色字体 / 底图规范 / 组件库 / 弹窗库 / 状态页 / 导航一致性 / 数据矩阵 / 产品流程亮点 / 任务流亮点 | 033、034、035、036、037、038、043 | 060、061、069、070 | 085-091 | `/design` sections |
| 开发者 | API Key / 工具调用日志 / Webhook / 质量看板 / 测试数据集 / 数据需求 | 030、032、036 | 058、068 | 092-096 | `/developers` 控制台 |
| 个人中心 | 身份选择 / 游客画像 / 登录 / 注册 / 画像城市/家庭/预算 / 记忆画像 / 通知 / 隐私安全 / 账号设置 / 记忆导出删除 | 002-010、028、029、031 | 046、047、056、066、067 | 097-100 | `/profile` + 登录注册弹窗 |
